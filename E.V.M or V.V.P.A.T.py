...
def rating():
    ...
    #webbrowser.get(path2).open('www.Google.com/feedback')
    webbrowser.open('www.Google.com/feedback')
    close()
def exit1():
    exit()
def globals():
...
def win3():
    ...
    btn7 = tk.Button(frame5, text="YSRCP", width=20, relief=RAISED, borderwidth=5, bg="#FF4500", command=YSRCP)
...
def counting():
    ...
    f = open('C:/Users/Public/Documents/vvpat.txt', 'a+')
    YSRCP1 = "Total Votes for YSRCP are:- "+str(b1)+"\n"
